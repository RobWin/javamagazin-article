...
Der Fokus der Dokumentation und der Inhaltsangabe liegt auf der Funktionalität, die von der API angeboten wird, und nicht auf den konkreten API Endpunkten.
